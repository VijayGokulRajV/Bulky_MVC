...
namespace BulkyWeb.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
	{
        ...
        public IActionResult UpdateOrderDetails()
        {
            ...
            TempData["success"] = "Order Details Update SuccussFully...!";
        ...
        public IActionResult CancelOrder()
        {
            ...
            if(orderHeader.PaymentStatus == SD.PaymentStatusApproved)
            {
                ...
                TempData["success"] = "Order Refunded SuccussFully...!";
            }
            else
            {
        ...
        {
            OrderHeader orderHeader = _unitOfWork.OrderHeader.Get(u => u.Id == orderHearderId);
            ...
            if (orderHeader.PaymentStatus == SD.PaymentStatusDelayedPayment)
            {
                ...
                {
                    _unitOfWork.OrderHeader.UpdateStripePaymentId(orderHearderId, session.Id, session.PaymentIntentId);
                    _unitOfWork.OrderHeader.UpdateStatus(orderHearderId, orderHeader.OrderStatus, SD.PaymentStatusApproved);
                    _unitOfWork.Save();
